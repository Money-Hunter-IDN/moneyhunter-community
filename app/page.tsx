  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <div className="relative">
        <section className="py-10 px-4 min-h-screen flex items-center justify-center">
          <div className="container mx-auto text-center max-w-4xl">
            ...
            <h1 className="text-4xl md:text-7xl font-bold mb-8 bg-gradient-to-r from-gray-900 via-gray-700 to-gray-900 bg-clip-text">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <a
                href="#features"
                className="inline-flex items-center justify-center px-5 py-3 text-lg font-semibold rounded-lg bg-[#FF5900] text-white hover:bg-[#FF5900]/80 hover:shadow-lg hover:shadow-[#FF5900]/25 transition-all duration-200 shadow-md"
              >
                Join Our Community
              ...
              <a
                href="#faq"
                className="inline-flex items-center justify-center px-5 py-3 text-lg font-semibold rounded-lg border-2 border-[#FF5900] text-[#FF5900] bg-white hover:bg-[#FF5900]/10 hover:text-[#FF5900] hover:shadow-lg hover:shadow-[#FF5900]/25 transition-all duration-200 shadow-sm group"
              >
                View FAQ
              </a>
            </div>
        ...
        <section id="features" className="py-30 px-4 flex items-center justify-center">
          <div className="container mx-auto max-w-6xl">
            <div className="grid lg:grid-cols-12 gap-8 items-center">
              ...
              <div className="lg:col-span-5">
                ...
                <div className="space-y-4">
                  <a href="https://t.me/moneyhunteridn" target="_blank" rel="noopener noreferrer" className="flex items-center justify-between p-4 bg-blue-50 hover:bg-blue-100 rounded-lg transition-colors group">
                  ...
                  <a href="https://discord.gg/PcrwafBjAA" target="_blank" rel="noopener noreferrer" className="flex items-center justify-between p-4 bg-indigo-50 hover:bg-indigo-100 rounded-lg transition-colors group">
                    <div className="flex items-center space-x-4">
                  ...
                  <a href="https://instagram.com/moneyhunteridn" target="_blank" rel="noopener noreferrer" className="flex items-center justify-between p-4 bg-pink-50 hover:bg-pink-100 rounded-lg transition-colors group">
                    <div className="flex items-center space-x-4">
                      <div className="w-12 h-12 bg-gradient-to-bl from-purple-600 via-pink-500 to-yellow-400 rounded-lg flex items-center justify-center">
        ...
        <section id="faq" className="py-30 px-4 flex items-center justify-center">
          <div className="container mx-auto max-w-3xl">
            ...
            <Accordion type="single" collapsible className="space-y-4">
              <AccordionItem value="item-1" className="bg-white/80 backdrop-blur-sm border-[#FF5900]/10 rounded-lg px-6 shadow-md shadow-[#FF5900]/5 hover:shadow-lg hover:shadow-[#FF5900]/10 transition-shadow duration-200">
                <AccordionTrigger className="text-gray-900 hover:text-[#FF5900] text-lg accordion-trigger">
        ...
        <footer className="py-8 px-4">
          <div className="container mx-auto text-center">
            ...
            <div className="flex justify-center space-x-6 mb-4 text-gray-600">
              ...
              <a href="https://discord.gg/moneyhunter" className="hover:text-gray-900">Discord</a>
              <a href="https://instagram.com/moneyhunteridn" className="hover:text-gray-900">Instagram</a>
            </div>
